  ...
  return (
    <footer className="max-container ">
      <div className="flex justify-between items-start gap-20 flex-wrap max-lg:flex-col ">
        <div className="flex flex-col items-start">
            ...
            <p className="mt-6 font-montserrat text-base leading-7 text-white-400 sm:max-w-sm">
              Get shoes ready for the new term at your Nearest Nike store. Got all sizes.
              </p>
        ...
        <div className="flex flex-1 justify-between lg:gap-10 gap-20 flex-wrap">
                  {footerLinks.map(section=>(
                    <div key={section}>
                      <h4 className="text-white mb-6 font-montserrat text-2xl leading-normal font-medium">{section.title}</h4>
                      <ul>
      ...
      <div className="flex justify-between text-white-400 mt-24 max-sm:flex-col max-sm:items-center">
                  ...
                  <p className="text-white-400 items-center">Re-craeted by:
              <span className='text-coral-red text-xl'> Steve Don </span>
            </p>
      </div>
